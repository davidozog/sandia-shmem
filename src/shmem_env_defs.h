...
SHMEM_INTERNAL_ENV_DEF(OFI_ENABLE_COLLECTIVES, bool, false, SHMEM_INTERNAL_ENV_CAT_TRANSPORT,
                       "Enable and prefer OFI libfabric collective operation implementations")
#endif
