...
SHMEM_INTERNAL_ENV_DEF(SYMMETRIC_HEAP_USE_SHARED_ALLOC, bool, true, SHMEM_INTERNAL_ENV_CAT_OTHER,
                       "Allocate the symmetric heap using shared alloc APIs provided by the device library")
